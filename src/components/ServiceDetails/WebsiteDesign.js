  ...
  return (
   ...
   <div className='row mt-lg-4'>
     ...
     <div className='col-lg-7 col-md-7 col-12'>
       ...
       <p>A website is the first point of contact with your customer. At Squash, we ensure that the first encounter is worth remembering for with an optimum user experience. Our team of developers and designers encode all necessary elements to make your website your Brand's Identity.</p>
       <h3>SQUASH'S 3 STEPS WEBSITE DESIGN MANTRA:</h3>
       ...
       <h3>8 AWESOME THINGS THAT SQUASH DOES THAT WILL MAKE YOU GO WOW!</h3>
       <ul>
