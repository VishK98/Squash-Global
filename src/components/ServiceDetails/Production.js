  ...
  return (
   ...
   <div className='row mt-lg-4'>
     ...
     <div className='col-lg-7 col-md-7 col-12'>
       ...
       <p>If an illustration implies a thousand words, a Video shows a thousand illustrations. Storytelling is an art. TAW-the agency ways is an artist who knows how to weave beautiful stories with moving pictures. Whether it is a six seconds ad film or a complete digital film, our team has got everything covered with their intimidating storytelling techniques. We craft videos that stands out compelling both your visual and auditory senses. With TAW, you can step into the full-scale video revolution era faster grasping the latest trends in a blink of an eye. Our video production services have been proven to better connect with the audiences and establish a dominant online presence. </p>
