        ...
        <div className="row">
          ...
          <div className="col-lg-8 col-md-8 col-12 mt-lg-5">
            ...
            <p className="paragraph-text" style={{ marginLeft: "5px" }}>
              Illustration implies a thousand word. That being said, arguably,
              none can deny the fact that Creatives are the sole of all types of
              marketing and advertising. From the time immemorial, Creative ads,
              posters, graphics are being imprinted on the mind of the
              consumers. Creative messages are so strong that consumers end up
              remembering a Brand with the creatives. But all are a fantasy
              dream and nothing else, if you lack the ability to use the power
              of Creative marketing to its fullest form.
              <p className="paragraph-text">
                At TAW, our creative advertising team collaborate on the
                creative concept for an advertising campaign and give meaning to
