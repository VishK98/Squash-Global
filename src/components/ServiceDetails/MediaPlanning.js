    ...
    <div className='container'>
      ...
      <div className='row mt-lg-4'>
        ...
        <div className='col-lg-7 col-md-7 col-12'>
          <div style={{height: "2px", width: "100%",background: "#fe504f",marginTop: "18px",marginTop:"30px"}}></div>
          ...
          <h3 style={{ fontSize: "35px" }}><span style={{ color: "#fe504f", fontSize: "35px"}}>3 PILLARS  OF  </span> MEDIA<br /> PLANNING</h3>
          ...
          <p className='service-description-3'>How about catching up for a <span style={{ color: "#fe504f" }}>Coffee!</span></p>
          <div style={{height: "2px", width: "100%",background: "#fe504f",marginTop: "18px"}}></div>
