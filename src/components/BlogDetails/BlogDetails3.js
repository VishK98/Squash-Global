  ...
  return (
    <>
      ...
      <div className="container mt-5 col-lg-8">
        ...
        <p className="paragraph-text">
          Don’t Worry! As a seasoned advertising agency, <a href="https://taw.agency/" className="Color-text" style={{ fontWeight: 'bold' }}>The Agency Way</a> has
        ...
        <p className="paragraph-text">
          ...
          for <a href="https://taw.agency/services/seo" className="Color-text" style={{ fontWeight: 'bold' }}>SEO</a>, social media, podcasts, or video, having a clear content
