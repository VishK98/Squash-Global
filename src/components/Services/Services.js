...
function Sector() {
  ...
  const routes = ["services/technology" , "#services/design", "services/socialmedia","#services/seo", "#services/paid-ads" , "services/digitalpr", "#services/influencer-marketing", "#services/production"];
